...
//简单判断
//if ( $matches[1] != 'www.vmgirls.com' && $matches[1] != 'zgboke.com' || $url == 'help') { //取消此行注释并注释下面一行，就能加入自定义的url过滤功能
if ( $url == 'help'){
    ...
    常规用法：<a href="http://q.4ker.cc?m=3&e=H&p=6&url=http://4ker.cc" target="_blank">http://q.4ker.cc?m=3&e=H&p=6&url=http://4ker.cc</a><br /><br />
    ';
	exit();
} else  {
    //调用二维码生成函数
